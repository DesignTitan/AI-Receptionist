...
values('aaaaaaaa-1111-4111-8111-111111111111','aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa','a@example.test','A','a','front','live','active','{}'),
...
begin
 b:=reserve_customer_booking('aaaaaaaa-1111-4111-8111-111111111111','member-1','Test','+12125550100',null,now()+interval '2 days',now()+interval '2 days 30 minutes');
 ...
 begin
 perform reserve_customer_booking('aaaaaaaa-1111-4111-8111-111111111111','member-1','Overlap','+12125550101',null,now()+interval '2 days 15 minutes',now()+interval '2 days 45 minutes');
 raise exception 'Overlap accepted'; exception when exclusion_violation then null; end;
 begin
 perform reserve_customer_booking('bbbbbbbb-1111-4111-8111-111111111111','member-1','Unpaid','+12125550100',null,now()+interval '2 days',now()+interval '2 days 30 minutes');
 ...
 perform reserve_customer_booking('aaaaaaaa-1111-4111-8111-111111111111','member-1','Replacement','+12125550102',null,now()+interval '2 days',now()+interval '2 days 30 minutes');
