...
export const metadata: Metadata = {
  ...
  description: "Online booking, AI confirmation calls and one place to follow up, for businesses that run on appointments. Coming soon.",
...
export default function ComingSoonPage() {
  return (
    <main id="main" className="hold-hero" aria-labelledby="hero-title">
      ...
      <p className="hold-hero__caption">Online booking. AI confirmation calls. One place to follow up.</p>
    </main>
  );
}
