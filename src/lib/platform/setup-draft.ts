...
export type SetupDraft={details:Record<string,string>;days:number[];opens:string;closes:string;timezone:string;team:TeamMember[]};
export function validateSetupDraft(value:unknown):SetupDraft{
 ...
 return {details,days:d.days,opens:d.opens,closes:d.closes,timezone:d.timezone,team};
}
