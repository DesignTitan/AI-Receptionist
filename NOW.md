...
- Replaced only the shared marketing navigation mascot with a compact single-color SVG (36px desktop, 32px mobile), tapered nub and smile only; removed eyes, winking and nodding. The bubs wordmark and click greeting remain.
