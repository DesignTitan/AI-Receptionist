...
const INDUSTRIES = [
  { key: "medical", outfit: "medical", problem: "A patient needs your full attention.", outcome: "Stay with your patient.", title: "Medical & dental", detail: "Doctors · dentists · clinics", line: "More time for your patients.", quote: "Hi Alex, does tomorrow at 10 still work for your appointment?", pilot: false },
  { key: "healthcare", outfit: "medical", problem: "You’re supporting every movement.", outcome: "Keep the session uninterrupted.", title: "Healthcare & wellness", detail: "Physio · mental health · chiropractic", line: "Give care your full attention.", quote: "Hi Sam, can you confirm your physio appointment tomorrow at 11?", pilot: false },
  { key: "fitness", outfit: "fitness", problem: "You can’t stop halfway through a set.", outcome: "Focus on the person you’re training.", title: "Fitness & movement", detail: "Gyms · personal trainers · yoga · Pilates", line: "Stay with the session.", quote: "Let’s book your first session. What day works for you?", pilot: true },
  { key: "care", outfit: "apron", problem: "Both hands. One customer. No interruptions.", outcome: "Keep your hands on the job.", title: "Personal care", detail: "Salons · barbers · spas · nail studios", line: "More time with your clients.", quote: "A haircut and colour? Which stylist would you like?", pilot: true },
  { key: "retail", outfit: "apron", problem: "There’s a customer at the counter.", outcome: "Help the customer in front of you.", title: "Retail & shops", detail: "Boutiques · showrooms · specialist shops", line: "Look after the customer in front of you.", quote: "Let’s arrange your showroom visit. What day suits you?", pilot: true },
  { key: "pets", outfit: "groomer", problem: "Wet paws. Full hands. A ringing phone.", outcome: "Finish the groom. Take the next booking.", title: "Pet services", detail: "Groomers · vets · trainers · boarding", line: "Busy hands. Bookings covered.", quote: "A bath or a full groom for Milo?", pilot: true },
  { key: "studio", outfit: "camera", problem: "The perfect moment won’t wait.", outcome: "Stay behind the camera.", title: "Creative studios", detail: "Photography · video · design studios", line: "Stay focused on the shoot.", quote: "A portrait session? Let’s find a time for you.", pilot: true },
  { key: "trades", outfit: "tools", problem: "You’re in the middle of a repair.", outcome: "Finish the job without phone tag.", title: "Home & auto services", detail: "Trades · cleaning · landscaping · mechanics", line: "Keep your attention on the job.", quote: "Hi Taylor, are you still available for Friday’s service appointment?", pilot: false },
  { key: "professional", outfit: "glasses", problem: "You’re deep in a consultation.", outcome: "Give the meeting your full attention.", title: "Professional services", detail: "Accountants · lawyers · consultants", line: "Make room for the conversation.", quote: "Hi Morgan, does Tuesday at 3 still work for your consultation?", pilot: false },
  { key: "lessons", outfit: "glasses", problem: "Your student needs you right now.", outcome: "Teach without interruptions.", title: "Lessons & coaching", detail: "Tutors · music · driving · coaching", line: "Keep the lesson flowing.", quote: "Your first piano lesson? What day works for you?", pilot: true },
  { key: "more", outfit: "glasses", title: "And many more.", problem: "Built around appointments?", outcome: "Let’s find where AI could give you time back.", detail: "Your business could be next.", line: "", quote: "", pilot: false },
];
