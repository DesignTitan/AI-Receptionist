...
/**
 * The holding site: the homepage hero and nothing else. One logo, centred at
 * the top. Served at /coming-soon, and at / when COMING_SOON=true. The wordmark
 * is inlined so this page looks the same on every branch.
 */
      ...
      <header className="hold-nav">
        <div className="rc-nav__brand rc-nav-mascot">
          <a href="/" className="rc-nav-mascot__wordmark" aria-label="bubs home">
            ...
            <span className="rc-nav-mascot__name">bubs<span className="hold-tm">™</span></span>
          </a>
        </div>
      </header>
      {children}
