...
export function getPages({ tenant = "", siteGate = "public" } = {}) {
  ...
  const pages = selected ? [] : [
    ...
    page("features", "Features & benefits", "/features", "Marketing", "app", "public",
      "Online booking, AI calls, owner controls, usage and guided setup.",
      ["src/app/(marketing)/features/page.tsx", "src/components/marketing/core-features.tsx", "src/lib/platform/pricing.ts"]),
  ...
  pages.push(
    ...
    page("campaign-images", "Marketing campaign images", "/__dev/design/campaign-v4/", "Marketing", "study", "development",
      "Ten Higgsfield photographs: owner moments, customer booking and a phone-evolution study.",
