    ...
    <div className="rc-overview__benefits" data-sc-in>
      <article>
        <div className="rc-benefit-art rc-benefit-art--booking" aria-hidden="true">
          ...
          <img className="rc-mini-mascot" src="/marketing/receptionist-mascot.png" width={1024} height={1024} alt="" />
        </div>
      ...
      <article>
        <div className="rc-benefit-art rc-benefit-art--routing" aria-hidden="true">
          ...
          <div className="rc-mini-routes">
            <div className="rc-mini-panel"><img src="/marketing/receptionist-mascot.png" width={1024} height={1024} alt="" /><span>AI</span><i /></div>
