...
const FEATURES: Feature[] = [
  ...
  },
  {
    key: "call",
    tab: "The call",
    screen: "/scrollcraft/06-call.jpg",
    alt: "The client's confirmation page, tracking the call as it happens.",
    caption: "A confirmation call inside a minute, while they are still on the page.",
  },
  {
    key: "record",
    tab: "The record",
    screen: "/scrollcraft/06-record.jpg",
    alt: "Today's calls, each with the outcome the assistant recorded.",
    caption: "Every call recorded, transcribed and summarised, in one list.",
  },
  {
    key: "flag",
    tab: "What needs you",
    screen: "/scrollcraft/06-flag.jpg",
    alt: "The bookings flagged after a no-answer or a reschedule request.",
