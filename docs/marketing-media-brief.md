...
The audience is the owner of an appointment business, starting with salons and similar services. A viewer should immediately recognize their own day: a customer in the chair, a busy reception area, a short errand, lunch, the end of a shift, or time off.

The main visual story is the owner getting that time back. Show the booking work alongside it so the benefit has a clear cause. Every scene must answer: what can this owner do, what appointment task does AI Receptionist handle, and where can the owner see the result?

## What the Starlink reference teaches

Inspected the official [Starlink Roam page](https://www.starlink.com/roam) in the browser on 9 September 2026. Its opening uses a broad natural setting; the scenario section shows a vehicle travelling, a campsite and a video call on a boat. The situations make the service relevant before the visitor needs to understand its technology.

Our interpretation: lead with a recognizable situation, connect it to one practical benefit, then show the product doing the work. Borrow the scale, visual restraint and clarity. Use original business situations and media. This research did not establish that Starlink uses a scroll-scrubbed video implementation; our scroll sequence is our own proposed treatment.

## Preserve the chosen opening

- Keep the exact V2 opening image: `design/hero-comparison/luxury-v2/assets/05-time-back.png`, showing the owner with coffee on a coastal terrace. Bubs explicitly liked this image and the SpaceX/Starlink-like UI after the earlier rejections.
- Keep the opening thought: **Step away. Bookings keep moving.**
- The supporting sentence must explain the available product. Today the demonstrated application story is online booking, an outgoing AI confirmation call and the owner's record. Incoming phone booking is a separate, locally built feature awaiting a verified voice connection.
- The Higgsfield V3 photo remains an alternative. Do not silently replace the approved V2 image with it.

## The six photo and video situations

These are the user's subjects, not six competing art directions. They belong to one coherent campaign. After hours extends the previously approved business-hours and vacation controls.

| Situation / suggested headline | The photograph | The video action | Product evidence beside the scene |
| --- | --- | --- | --- |
| **With a customer — “Give them your full attention.”** | A stylist focused on a client in a credible boutique salon. Tools, hands, hair and mirror reflections must be correct. Neither person looks at the camera. | A slow move past the chair while the service continues; the owner does not stop to use a phone. | A second customer selects an available appointment online; a confirmation call and saved result follow. The future incoming-booking version can use a verified pilot call. |
| **Too busy to answer — “Make room for the next booking.”** | A full working salon: one person checking out, another being welcomed, staff occupied. Busy, believable and organized. | A short tracking shot across reception; cut to a caller asking for an appointment and a saved booking. Keep the same business and clear continuity. | This is the core incoming-call story: AI finds a slot and saves it after caller agreement. Produce as a clearly identified demonstration until real call acceptance passes. |
| **Away from the desk — “Your front desk can keep up.”** | The owner walking from reception to greet a client or gather supplies. An unattended desk is visible in context, within a functioning business. | Follow the owner away from reception, then show the selected answering choice handling an appointment request. | Owner chooses menu, staff first or AI first. Phone-routing footage needs the verified connection; existing online booking can demonstrate continuity today. |
| **Taking a break — “Take your break.”** | A proper lunch or coffee in the salon courtyard, phone put away. This is an ordinary break during a working day, distinct from a vacation. | A seated conversation, a cup set down, a natural breath of quiet. Minimal camera movement. | An online booking and outgoing confirmation happen independently; the owner can review the record afterward. A temporary AI-answering setting is a later verified phone version. |
...
Keep the mechanics readable in HTML or an actual interface capture. Generated media supplies the people, space and camera movement. It must not invent appointment details, notification delivery, prices or confirmation states.

For the incoming phone story, the complete sequence is:

**Customer calls → owner’s answering choice → AI checks a real slot → caller agrees → appointment is saved → owner sees the record.**

For the current online/outgoing story:

**Customer books online → AI calls to confirm if enabled → owner sees the booking and call outcome.**

Do not combine these into an unexplained montage. The visitor should be able to tell which flow they are watching.

## Proposed V2 page order and movement
...
Start with photographs as durable poster frames. Use restrained 5–8 second motion for individual human scenes; avoid demanding a long scrub gesture through every scene. Reserve a short scroll-controlled sequence for the connected booking/call/record demonstration, where scrolling helps explain cause and effect. Precise timing depends on the approved footage and browser testing. Provide stills for reduced motion and compose mobile deliberately.

Phone evolution may remain a short optional transition near the product explanation. It should occupy no more than roughly one fifth of that explanation; human benefit and product evidence get the rest. The phone, empty atrium and floating-interface studies are reference material, not the main campaign sections.

## Visual and production direction

- Aim for a premium documentary campaign: real-looking environments, natural light, believable skin, hair, tools and working posture; no posing at the viewer, waxy faces, theatrical panic or stock-photo headset smiles.
- Use one consistent fictional owner/business across work scenes and appropriate continuity through the time-off scenes. Tanaz is the pilot context, not permission to invent photographs or testimonials of its real staff.
- Luxury comes from composition, space, attention and time. Keep the website framing clean and dark, with large imagery and sparse white typography. The salon itself should feel usable and welcoming, not like a spacecraft interior.
- Use Higgsfield as requested. Confirm the current still-image and image-to-video models before production. The earlier interpretation of “Canto 2.5” as Cinema Studio Image 2.5 was not a verified model alias. Judge actual output quality; no model choice guarantees perfect realism.
- Review stills in the requested 1:1 comparison format. Plan separate wide desktop and portrait mobile compositions for final placement. Do not assume every square frame can crop successfully into both.
- Motion should come from the camera and ordinary human/environmental movement. Avoid morphing people, melting phones, floating objects, ornamental waveforms and generated UI lettering.
...
- Within five seconds, a viewer can identify the business problem and explain why the owner has more time.
- Every photo shows a requested situation; every adjacent product state explains how appointments are handled.
- A viewer can distinguish online booking, outgoing confirmation and incoming AI answering.
