...
- Canonical portrait: `assets/mascot-cuddle.png`.
...
- Default expression: closed smiling crescent eyes and open happy forest-green smile. Keep cheeks when creating other expressions.
