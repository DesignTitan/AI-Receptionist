...
import { SetupJourney } from "@/components/platform/setup-v2/setup-journey";
import styles from "./page.module.css";

export const dynamic = "force-dynamic";

/**
 * Version 2 of business setup, start to finish, built for side-by-side
 * comparison with the current form. Dev-only until a decision is made; it
 * saves to this browser and never to a customer record.
 */
