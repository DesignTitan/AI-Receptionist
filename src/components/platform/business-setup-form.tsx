...
export function BusinessSetupForm({
  ...
  const [team, setTeam] = useState(
      customer?.config.team.length ? customer.config.team : [
    ...
    >
        ...
        <div className="platform-fields">
          <label>
            ...
            <input
              ...
              required
              maxLength={120}
              defaultValue={customer?.config.setupPending ? "" : customer?.business_name}
            />
          </label>
          <label>
            Business type
      ...
      <fieldset>
        ...
        <button
          ...
          disabled={team.length >= PLANS[chosen].teamLimit}
          onClick={() =>
            setTeam([
              ...team,
      ...
      <button disabled={busy}>
        {busy ? "Saving your setup…" : "Save business details →"}
      </button>
      <p className="platform-note">
        Once you save, we prepare your booking page and phone line, test them
